...
import lib.frc254.geometry.Rotation2d;
...
public class Util {
	...
	public static Pose2d toWPILibPose(lib.frc254.geometry.Pose2d pose) {
		return new Pose2d(
	...
	public static lib.frc254.geometry.Pose2d to254Pose(Pose2d pose) {
		return new lib.frc254.geometry.Pose2d(
